...
class Menu(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        menu_button3.grid(row=1, column=0, sticky="nswe", columnspan=2)

        menu_slider1.grid(row=2, column=0, rowspan=2, sticky="nsew", pady=3)
        menu_slider2.grid(row=2, column=2, rowspan=2, sticky="nsew", pady=3)
