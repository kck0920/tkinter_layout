...
window.geometry("600x600+1200+300")
...
menu_toggle1 = ttk.Checkbutton(toggle_frame, bootstyle='success', text='check 1')
menu_toggle2 = ttk.Checkbutton(toggle_frame, bootstyle='success', text='check 2')

entry = ttk.Entry(menu_frame)

# menu layout => use grid()
...
# toggle layout => use grid(), pack()
toggle_frame.grid(row=4, column=0, columnspan=3, sticky='nsew')
menu_toggle1.pack(side='left', expand=True)
menu_toggle2.pack(side='left', expand=True)

# entry layout
entry.place(relx=0.5, rely=0.95, relwidth=0.9, anchor='center', y=10)
